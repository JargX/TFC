...
public class Excel {
    ...
    /**
     * Método estático para generar un reporte de productos en un archivo Excel.
     */
    public static void reporte() {
        Workbook book = new XSSFWorkbook(); // Crear un libro de trabajo Excel
        Sheet sheet = book.createSheet("Productos"); // Crear una hoja llamada "Productos"
        ...
        try {
            ...
            // Conectar a la base de datos y obtener los datos de los productos
            ...
            String fileName = "inventarioProductos";
